        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('oauth.scim.user.update') }}">
                            @csrf

                            <input type="hidden" id="user_id" name="user_id" value="{{$user['id']}}">

                            <div class="form-group row">
                                <label for="first_name" class="col-md-4 col-form-label text-md-right">Given Name</label>
                            ...
                            <div class="form-group row">
                                <label for="last_name" class="col-md-4 col-form-label text-md-right">Family Name</label>
                            ...
                            <div class="form-group row mb-0">
                                <div class="col-md-6 offset-md-4">
                                    ...
                                    <button onclick="window.location.href='/users/{{$user['id']}}/show'" class="btn btn-primary float-right">
                                        Cancel
                                    </button>
                                </div>
                            </div>
